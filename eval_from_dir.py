...
def eval_from_dir():
    ...
    loader_container = LoaderContainer(dataset_dir=dataset_dir, batch_size=128, shuffle=False,
    ...
    for item in contents:
        ...
        if os.path.isdir(cur_dir):
            ...
            if is_feature and (feature_nums == feature_num or feature_nums == 0):
                ...
                feature_encoder = torch.load(os.path.join(cur_dir, 'pretrained_encoder.pt'), map_location='cpu')
